...
public class SkuController {
    ...
    public Result decr(@RequestParam(value = "username", required = false) String username) {
    ...
    public Result<List<Sku>> findSkusByStatus() {
        List<Sku> list = skuService.findSkusByStatus();

...
public class TemplateController {
     ...
     * @return
     * @Author mqy
     * @Description 根据categoryId查询模板对象
     * @Date
     * @Param
     **/
    @GetMapping("/list/{id}")
    public Result<Template> list(@PathVariable(value = "id") Integer id) {
        Template templateByCategoryId = templateService.findTemplateByCategoryId(id);
        return new Result<>(true, StatusCode.OK, "查询成功", templateByCategoryId);
    }

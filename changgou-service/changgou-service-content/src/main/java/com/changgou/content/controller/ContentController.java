...
public class ContentController {
     ...
     * @return
     * @Author mqy
     * @Description 根据categoryId查询广告集合
     * @Date
     * @Param
     **/
    @GetMapping("/list/{id}")
    public Result<List<Content>> findByContent(@PathVariable(value = "id") Long id) {
        List<Content> contents = contentService.findByContent(id);

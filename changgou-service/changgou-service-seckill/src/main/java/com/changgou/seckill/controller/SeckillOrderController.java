...
public class SeckillOrderController {
    ...
    public Result queryStatus() {
        ...
        if (seckillStatus != null) {
            return new Result(true, StatusCode.OK, "用户抢单状态查询成功", seckillStatus);
        } else {
            return new Result(false, StatusCode.OK, "无  用户抢单状态");
        }
    }
    ...
    public Result add(String time, Long seckillId) {
        try {
            ...
            Boolean add = seckillOrderService.add(time, seckillId, userId);
            if (add) {
